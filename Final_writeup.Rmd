...
#  separate(Start_time, into = c("new_hour", "new_minute", sep = ":"))
...
ui <- fluidPage(
  ...
  tabsetPanel(tabPanel("Overview",
      ...
      p("This data set is a collection of observations of horses in turnout at St. Lawrence Universities riding facility.", style = "color:brown"), 
      p("Enjoy navigating these tabs in the top left to compare horse performance in turnout in various conditions.", style = "color:brown"), 
      p("Horses were each assigned personality types and plots can be adjusted to only show the type or types you are interested in.", style = "color:brown"), 
      p("Select inputs from the selections on the left side of the screen and watch the plots change!", style = "color:brown"),
      p("Finally, scroll down on the pages to make sure you are not missing any additional content.", style = "color:brown"), 
