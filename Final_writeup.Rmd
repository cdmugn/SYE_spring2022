...
An article by Foster also spoke to horse personalities, identifying the same four types as Barteau. The main focus of Foster’s article is  the way horses express discomfort with minimal movement. She identifies that the eyes and other facial indicators are the most informative signals and that changes in body posture and natural movement are other signals to how a horse feels in turnout (2019).
