...
negativepersonality <- turnout_data %>% group_by(Personality) %>% summarise(meannegative = mean(Totalnegativesigns)) %>% arrange(meannegative)
...
kable(negativepersonality, digits = 2, caption = "Average Number of Negative Signs for each Personality",
  col.names = c("Personality", "Average Negative Signs"))


ggplot(data = turnout_data, mapping = aes(x = Personality, y = Totalnegativesigns)) +
  geom_boxplot(color = "purple4", fill = "mediumpurple1") +
  theme_stata() +
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1, color = "white"), plot.title = element_text(color = "white"), plot.background = element_rect(fill = "navajowhite4"), axis.text.y = element_text(color = "white"), axis.title = element_text(color = "white")) + 
...
```{r, echo=FALSE}
ggplot(data = turnout_data, mapping = aes(x = Time_of_day, y = Totalnegativesigns)) +  geom_boxplot(color = "purple4", fill = "mediumpurple1") +
  theme_stata() +
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1, color = "white"), plot.title = element_text(color = "white"), plot.background = element_rect(fill = "navajowhite4"), axis.text.y = element_text(color = "white"), axis.title = element_text(color = "white")) + 
...
```{r, echo=FALSE}
ggplot(data = turnout_data, mapping = aes(x = Age, y = Totalnegativesigns)) + geom_point(color = "purple4") + geom_smooth(se = FALSE, color = "mediumpurple1") +  theme_stata() +
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1, color = "white"), plot.title = element_text(color = "white"), plot.background = element_rect(fill = "navajowhite4"), axis.text.y = element_text(color = "white"), axis.title = element_text(color = "white")) + 
...
```{r, echo=FALSE}
ggplot(data = turnout_data, mapping = aes(x = Time_of_day, y = Totalnegativesigns)) + geom_point(color = "purple4") + geom_smooth(se = FALSE, color = "mediumpurple1") +  theme_stata() +
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1, color = "white"), plot.title = element_text(color = "white"), plot.background = element_rect(fill = "navajowhite4"), axis.text.y = element_text(color = "white"), axis.title = element_text(color = "white")) + 
  labs(title = "Time of Day vs. Total Negative Signs", y = "Total Negative Signs", x = "Time of Day")
```
...
```{r, echo=FALSE}
ggplot(data = turnout_data, mapping = aes(x = Flymask, y = Totalnegativesigns)) +  geom_boxplot(color = "purple4", fill = "mediumpurple1") +
  theme_stata() +
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1, color = "white"), plot.title = element_text(color = "white"), plot.background = element_rect(fill = "navajowhite4"), axis.text.y = element_text(color = "white"), axis.title = element_text(color = "white")) + 
...
```{r, echo=FALSE}
ggplot(data = turnout_data, mapping = aes(x = Flysheet, y = Totalnegativesigns)) +  geom_boxplot(color = "purple4", fill = "mediumpurple1") +
  theme_stata() +
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1, color = "white"), plot.title = element_text(color = "white"), plot.background = element_rect(fill = "navajowhite4"), axis.text.y = element_text(color = "white"), axis.title = element_text(color = "white")) + 
...
```{r, echo=FALSE}
ggplot(data = turnout_data, mapping = aes(x = Type_of_turnout, y = Totalnegativesigns)) +  geom_boxplot(color = "purple4", fill = "mediumpurple1") +
  theme_stata() +
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1, color = "white"), plot.title = element_text(color = "white"), plot.background = element_rect(fill = "navajowhite4"), axis.text.y = element_text(color = "white"), axis.title = element_text(color = "white")) + 
...
ggplot(turnout_data, aes(x=minutes_spent_pacing,y=Totalnegativesigns)) + 
  geom_point(color = "purple4") + geom_smooth(se = FALSE, color = "mediumpurple1", method = lm) + facet_wrap("Horse") +  theme_stata() + theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1, color = "white"), plot.title = element_text(color = "white"), plot.background = element_rect(fill = "navajowhite4"), axis.text.y = element_text(color = "white"), axis.title = element_text(color = "white")) + 
...
```{r, echo=FALSE}
ggplot(turnout_data, aes(x=Personality,y=Totalnegativesigns)) + geom_boxplot(color = "purple4", fill = "mediumpurple1") +
  theme_stata() +
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1, color = "white"), plot.title = element_text(color = "white"), plot.background = element_rect(fill = "navajowhite4"), axis.text.y = element_text(color = "white"), axis.title = element_text(color = "white")) + 
  labs(title = "Personality vs. Total Negative Signs", y = "Total Negative Signs", x = "Personality")
```
...
Need to make everything ordered so the plots make sense - how to best do?
...
Change boxplots to dot and error bar plots so they show variability?
