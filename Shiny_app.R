...
ui <- fluidPage(
  ...
  tabsetPanel(tabPanel("Overview",
         ...
         h4("This data set is a collection of observations of horses in turnout at St. Lawrence Universities riding facility.", style = "color:darkbrown"), 
         br(),
         h4("Enjoy navigating these tabs in the top left to compare horse performance in turnout in various conditions.", style = "color:darkbrown"), 
      br(),
      h4("Horses were each assigned personality types and plots can be adjusted to only show the type or types you are interested in.", style = "color:darkbrown"), 
      br(),
      h4("Select inputs from the selections on the left side of the screen and watch the plots change!", style = "color:darkbrown"),
      br(),
      h4("Finally, scroll down on the pages to make sure you are not missing any additional content.", style = "color:darkbrown"),
      br(),
              uiOutput("tab"),
      br(),
